...
export default function Posts(){
    ...
    const handlePos = async (id,rate) => {
        ...
        setPosRate(posRate)
        Axios.put("https://team20-seffafkart.herokuapp.com/api/updateposrate", {
    ...
    const handleNeg = async (id,rate) => {
        ...
        Axios.put("https://team20-seffafkart.herokuapp.com/api/updatenegrate", {
      ...
      const handleDecPos = (id) => {
        voted[id] = "";
        Axios.put("https://team20-seffafkart.herokuapp.com/api/decreaseposrate", {
          admin_act_id: id,
          user_id: user[0].id,
        })
      }
      ...
      const handleDecNeg = (id) => {
        voted[id] = "";
        Axios.put("https://team20-seffafkart.herokuapp.com/api/decreasenegrate", {
          admin_act_id: id,
          user_id: user[0].id,
        })
      }
    ...
    useEffect(() => {
        Axios.get('https://team20-seffafkart.herokuapp.com/api/admin_acts')
        .then(res => {
